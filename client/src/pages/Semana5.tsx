...
export default function Semana5() {
  const tasks = [
    {
      id: 1,
      title: "Azure DevOps Completa",
      description: "Criar aba 'Roadmap' na Ficha Cliente e dashboard geral de roadmap.",
      status: "pending",
      date: "17-20 Fev",
      impact: "Alto"
    },
    {
      ...
      description: "Iniciar testes ponta-a-ponta de todas as integrações e funcionalidades.",
      status: "pending",
      date: "21-23 Fev",
      impact: "Alto"
    }
    ...
    <Layout>
      <div className="space-y-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-white">Semana 5: Roadmap Completo e Testes</h1>
            <p className="text-slate-400 mt-2">
              Consolidação da visão de produto e garantia de qualidade do sistema integrado.
            </p>
          </div>
          <div className="flex items-center gap-2 bg-orange-500/10 px-4 py-2 rounded-lg border border-orange-500/20">
            <Clock className="h-5 w-5 text-orange-500" />
            <span className="font-medium text-orange-400">17 Fev - 23 Fev</span>
          </div>
        </div>
        ...
        <Card className="bg-gradient-to-r from-slate-900 to-slate-800 border-slate-700">
          <CardHeader>
            <CardTitle className="text-xl text-white">Próxima Fase: Finalização e Entrega</CardTitle>
            <CardDescription className="text-slate-400">
              Prepare-se para a Semana 6 (24 Fev - 28 Fev)
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col md:flex-row gap-6 items-center">
              <div className="flex-1 space-y-2">
                <p className="text-sm text-slate-300">
                  Na última semana, faremos o polimento final, correção de bugs e prepararemos
                  a apresentação para a entrega oficial do projeto.
                </p>
              </div>
              <div className="flex items-center gap-4 bg-black/20 p-4 rounded-lg backdrop-blur-sm border border-white/5">
                <div className="text-center">
                  <p className="text-2xl font-bold text-orange-500">1.0</p>
                  <p className="text-xs text-slate-400">Semana</p>
                </div>
                <div className="h-8 w-px bg-white/10"></div>
                <div>
                  <p className="font-medium text-sm text-white">Duração Estimada</p>
                  <p className="text-xs text-slate-400">Reta Final</p>
                </div>
              </div>
            </div>
          </CardContent>
